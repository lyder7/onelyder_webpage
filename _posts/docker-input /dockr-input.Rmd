...
Artikkelen jeg fulgte, [install configure docker ubuntu](https://linuxhint.com/install_configure_docker_ubuntu/), skrevet av linuxhint.com som også har amdre bra artikler og veiledninger. Personlig foretrekker jeg ofte å lese disse, enn å se Youtube videoer.
...
`Docker` bringer noen interessange egenskaper, som gjør miljøet man programmerer i mer optimalt.
