...
description: | 
  Excel-relaterte problemstillinger, som blir løst med R kode. Funksjoner, loops og map blir disktuert og vist eksempler fra.
author: 
...
Denne lille spalten er inspirert av Bruno Rodriguez sin video [Don't write loops in R](https://www.youtube.com/watch?v=3xIKZbZKCWQ&t=0s).
