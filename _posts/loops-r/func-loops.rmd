...
description: | 
  Denne teksten tar for seg Excel-relaterte problemstillinger, som blir løst med R kode. Funksjoner, loops og map blir disktuert og vist eksempler fra.
author: 
...
[Don't write loops in R](https://www.youtube.com/watch?v=3xIKZbZKCWQ&t=0s)
...
I tilegg spesifiserer jeg hvilken filtype jeg ønsker å lete etter.

```{r list.files1, eval=FALSE}
list.files(".", pattern = ".xlsx")
```

Men jeg kan også spesifere at jeg vil lete i et spesifikt område i mappen min.
Jeg har laget en egen mappe data, og der ligger det flere excelfiler.
...
```{r listfiles-objekt, eval=FALSE}
list_xlsx <- list.files("/home/lyder/dev_lyder/github_lyder7/onelyder_webpage/_posts/loops-r", pattern = ".xlsx")
```
